...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/build/lede-17.01/slaves/phase1/ar71xx_generic/build/staging_dir/host/bin/grep -E"}
	: ${FGREP="/build/lede-17.01/slaves/phase1/ar71xx_generic/build/staging_dir/host/bin/grep -F"}
	: ${GREP="/build/lede-17.01/slaves/phase1/ar71xx_generic/build/staging_dir/host/bin/grep"}
	: ${SED="/build/lede-17.01/slaves/phase1/ar71xx_generic/build/staging_dir/host/bin/sed"}
fi
